...
declare module 'adaptivecards/card-elements' {
	import * as Enums from 'adaptivecards/enums';
	import { PaddingDefinition, SizeAndUnit, Dictionary, StringWithSubstitutions, IInput, IResourceInformation } from 'adaptivecards/shared';
	import { HostConfig, BaseTextDefinition, FontTypeDefinition, ColorSetDefinition, TextColorDefinition, ContainerStyleDefinition } from 'adaptivecards/host-config';
